...
if __name__ == '__main__':
    ...
    # # 开发测试用
    # conn = None
    # query_res = plate_match(conn, ['HK-93', 'HK-92'],  [('7', '8', '9'), ('4', '5', '6', '7', '8', '9', '10')],['2019-10-08 16:00:00', '2019-10-08 15:50:00'], ['2019-10-08 18:00:00', '2019-10-08 18:10:00'])
    # result = dataframe_Tolist(query_res)
    # print(result)
    # Insert_db(conn, 'TRAVEL_TIME_HK92TOHK93', result)
    ## 跑批量数据用的
    start_time_list, end_time_list = Start_End_time_list('2019-10-08 16:30:00', 1)
    for i in range(len(start_time_list)):
        conn = None

        # # 下面是包含路中卡口的4个子路段
        query_res = plate_match(conn, ['HK-92', 'HK-107'], [('1', '2', '3'), ('1', '2')], start_time_list[i],
                                end_time_list[i])  # 起：HK-107；终：HK-92。跑该子段时取消注释
